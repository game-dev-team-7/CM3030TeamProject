Shader "Custom/HardcodedTwoRectangularHighlightShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            static const float2 rect1Center = float2(0.35, 0.65); // Center of Highlight 1
            static const float2 rect1Size = float2(0.07, 0.08); // Size of Highlight 1
            static const float2 rect2Center = float2(0.65, 0.59); // Center of Highlight 2
            static const float2 rect2Size = float2(0.08, 0.18); // Size of Highlight 2
